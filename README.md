...
A comparative analysis revealed that the if-else-based ALU resulted in slightly lower area and better timing performance, while the case-based ALU exhibited higher logic complexity and marginally increased delay due to sequential decision evaluation. Both designs, however, produced identical functional outputs.
